...
const loadData = async () => {
    ...
    try {
        ...
        const orderData = await orderStore.getPurchaseOrder(orderId);
        ...
        if (order.supplier) {
            ...
            supplierSearch.value = order.supplier.company_name;
        }
...
const handleSubmit = async () => {
    ...
    try {
        ...
        await orderStore.updatePurchaseOrder(route.params.id, orderData);
