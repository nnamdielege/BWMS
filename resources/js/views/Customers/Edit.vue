        ...
        <div v-else>
            ...
            <div class="page-header">
                <div>
                    ...
                    <p class="page-subtitle">{{ form.company_name }}</p>
                </div>
            </div>
            ...
            <div class="form-card">
                <form @submit.prevent="handleSubmit">
                        ...
                        <div class="form-grid">
                            <div class="form-group">
                                ...
                                <input
                                    ...
                                    required
                                />
                                <p v-if="errors.customer_code" class="form-error">{{ errors.customer_code[0] }}</p>
                            </div>
                        ...
                        <div class="form-group">
                            <label class="flex items-center cursor-pointer">
                                <input
                                    ...
                                    class="form-checkbox"
                                />
                                <span class="ml-2 text-gray-700">Active Customer</span>
                            </label>
                    ...
                    <div class="form-actions">
                        <router-link to="/customers" class="btn-cancel">
                            Cancel
                        </router-link>
                        <button
                            type="submit"
...
const handleSubmit = async () => {
    ...
    try {
        const id = route.params.id;
        await customerStore.updateCustomer(id, form);
