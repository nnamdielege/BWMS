  ...
  <div class="subscription-manager">
    <div class="container">
      ...
      <div v-else class="subscription-content">
        ...
        <div v-if="subscriptionStore.subscription.status === 'active'">
          <!-- Current Plan Card -->
          <div class="plan-card">
            ...
            <div class="plan-details">
              <div class="detail-row">
                <span>Price:</span>
                <strong>${{ subscriptionStore.subscription.plan.price }}/month</strong>
              </div>
          ...
          <!-- Plan Features -->
          <div v-if="subscriptionStore.subscription.plan.features" class="features-section">
            <h3>Plan Features</h3>
        ...
        <div v-else-if="subscriptionStore.subscription.status === 'cancelled'">
          <div class="alert alert-warning cancelled-alert">
            <div class="alert-content">
              <div class="alert-message">
                <h3>⚠️ Subscription Cancelled</h3>
                <p v-if="subscriptionStore.subscription.cancel_at_period_end">
                  Your subscription is scheduled to be cancelled on {{ subscriptionStore.renewalDate }}.
                </p>
                <p v-else>
              ...
              <router-link to="/add-payment-method" class="btn btn-secondary">
          ...
          <div class="plan-card">
            ...
            <div class="plan-details">
              ...
              <div class="detail-row">
                ...
                <strong>{{ subscriptionStore.subscription.cancelled_at ? formatDate(subscriptionStore.subscription.cancelled_at) : 'N/A' }}</strong>
              </div>
            </div>
          </div>
        </div>
